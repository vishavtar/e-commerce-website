...
console.log(store_local_user_details)
   profileImageString = store_local_user_details.avatar.replace("/home/hpvbfsvg/", "https://www.");
  console.log("image",profileImageString);
